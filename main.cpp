...
GLuint loadShaders(const char * vertex_file_data, const char * fragment_file_data) {
    ...
    glShaderSource(VertexShaderID, 1, &vertex_file_data , NULL);
    ...
    glShaderSource(FragmentShaderID, 1, &fragment_file_data , NULL);
